    ...
    <section class="jenis pt-0">
        <div class="container mt-md-5">
            <div class="text-center title">
                <h3 class="mx-4 my-0 text-center">Sektor Ekonomi</h3>
            </div>
                    ...
                    <div class="image-block-inner" style="border-radius:25px;">
                        <a class="mh-100" href="">
                            <img src="https://static.vecteezy.com/system/resources/thumbnails/001/849/553/small_2x/modern-gold-background-free-vector.jpg"
                                alt="penting memilih produk asuransi jiwa dengan eats" class="img-responsive w-100"
                                style="border-top-left-radius: 25px;border-top-right-radius: 25px;height:200px;">
                        </a>
                        <span class="hp-posts-cat">jenis</span>
                        <h4 class="mt-3"><a href="" style="font-size:20px;margin-bottom:1px;">Jl.simokerto</a>
                        </h4>
                        <!--  <p></p> -->
