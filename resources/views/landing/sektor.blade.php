    ...
    <section class="sektor pt-0" style="background-color:whitesmoke">
        <div class="container mt-md-5">
            <div class="text-center title">
                <h3 class="mx-4 my-0 text-center">Sektor Gedung</h3>
            </div>
        ...
        <div class="text-center">
            <a class="btn" href="{{ url('sektor') }}" role="button"
                style="background:#2c588f;color:white;border-radius:40px;">Lihat Semua Sektor</a>
        </div>
    </section>
