    ...
    <section class="jenis pt-0">
        <div class="container mt-md-5">
            ...
            <ul class="image-block list-unstyled">
                ...
                <li class="jenis-item" data-aos="fade-up" data-aos-delay="{{ $key * 100 }}">
                    <div class="image-block-inner">
                        <a href="{{ route('beranda.jenis', [$value->id]) }}" class="position-relative">
                            <img src="{{ $value->foto ? asset('fotoJenis/' . $value->foto) : asset('img/sby/bg-landing.jpg') }}" 
            ...
            <div class="text-center mt-5" data-aos="fade-up">
                ...
                <h4 style="color: #64748b">Belum ada data jenis bangunan untuk sektor ini.</h4>
            </div>
            @endif
        </div>
    </section>
